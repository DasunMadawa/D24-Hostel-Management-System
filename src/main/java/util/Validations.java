...
public class Validations {
    ...
    public static final Pattern roomPattern = Pattern.compile("^(R)[0-9]{3}$");
    public static final Pattern studentPattern = Pattern.compile("^(S)[0-9]{3}$");
    public static final Pattern resPattern = Pattern.compile("^(RE)[0-9]{3}$");
